...
export const ALL_CURRICULUM_LESSONS: Record<string, LessonIndexItem[]> = {
  ...
  'secondary-2as-arts-arts': [
    { title: "المدخل النظري والتاريخي للفنون وتطور التيارات التشكيلية والمسرحية", description: "النشأة، المدارس الفنية الكبرى (الكلاسيكية، الرومانسية، الواقعية)، والتقنيات التعبيرية الأولية.", semester: 1, },
    { title: "قواعد التكوين البصري والمنظور وعلم الألوان وقوانين التوافق اللوني", description: "دائرة الألوان، التباين والتكامل، المنظور الخطي والهوائي، والظل والنور والقيم الضوئية.", semester: 2, },
    { title: "فنون الأداء والإخراج الصوتي والمسرحي ومبادئ السمعي البصري", description: "لغة الجسد، مخارج الحروف، التقطيع الفني (Storyboard)، وأساسيات التصوير والإضاءة والمونتاج.", semester: 3, },
  ],
  'secondary-3as-arts-arts': [
    { title: "تاريخ الفن الحديث والمعاصر والمدارس الفنية الكبرى (التكعيبية، التجريدية، السريالية)", description: "تحليل الأعمال التشكيلية الكبرى لبيكاسو، كاندينسكي، دالي، وخصائص الثورة الجمالية المعاصرة.", semester: 1, },
    { title: "السينوغرافيا وفنون العرض المسرحي والدراما والسيناريو والتحليل النقدي", description: "كتابة السيناريو والحوار، الفضاء المسرحي، الديكور والأزياء والإضاءة، وبناء الشخصيات الدرامية.", semester: 2, },
    { title: "الصناعة السمعية البصرية والسينما والإخراج والمشروع الإبداعي التخرجي للبكالوريا", description: "تقنيات الإخراج السينمائي والتلفزيوني، المونتاج الرقمي، هندسة الصوت، وإعداد المشروع الفني النهائي لشهادة البكالوريا.", semester: 3, },
  ],
};
